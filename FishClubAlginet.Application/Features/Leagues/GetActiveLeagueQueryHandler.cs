...
public record GetActiveLeagueQuery : IRequest<ErrorOr<LeagueDto>>;

public class GetActiveLeagueQueryHandler
    : IRequestHandler<GetActiveLeagueQuery, ErrorOr<LeagueDto>>
{
    private readonly IGenericRepository<League, Guid> _repository;

    public GetActiveLeagueQueryHandler(IGenericRepository<League, Guid> repository)
    {
        _repository = repository;
    }

    public Task<ErrorOr<LeagueDto>> Handle(GetActiveLeagueQuery request, CancellationToken cancellationToken)
    {
